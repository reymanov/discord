  ...
  return (
    <>
      <button
        ...
        className="dark:hover-bg-zinc-700/50 group flex w-full items-center gap-x-2 rounded-md px-2 py-2 transition hover:bg-zinc-700/10">
